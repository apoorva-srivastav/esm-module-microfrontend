// esbuild-css-modules-plugin-namespace:/var/folders/90/23sdvz916v38vly32_hh_f0r0000gn/T/tmp-67012-Zl6lxpNLc8l5/ui/src/Button/Button.module.css.js
var digest = "d403e2af4dc3628979a602fffb8132513c8901919181ff2887f282bac522fe94";
var css = `._button_w2953_1{
    background-color: rgb(251, 252, 253);
    color: rgb(11, 14, 122);
    border: 1px solid rgb(11, 14, 122);
    padding: 0 20px;
    margin: 10px;
}
`;
...
var Button_module_css_default = { "button": "_button_w2953_1" };

// src/Button/Button.jsx
import { jsx } from "react/jsx-runtime";
var Button = ({ text, onClick, disable = false, children, ...props }) => {
  return /* @__PURE__ */ jsx("button", { className: Button_module_css_default.button, onClick: () => onClick(), disable, ...props, children: text || children });
};

// esbuild-css-modules-plugin-namespace:/var/folders/90/23sdvz916v38vly32_hh_f0r0000gn/T/tmp-67012-T1I5xUXYcV63/ui/src/Header/Header.module.css.js
var digest2 = "4e0341faf764c04ec3c178ed5be7b5c371ee9085efc0876523498ca04ba42102";
var css2 = `._headerTab_1nkth_1{
    background-color: rgb(221, 227, 237);
    color: rgb(11, 14, 122);
    padding: 0 20px;
    display: flex;
...
var Header_module_css_default = { "headerTab": "_headerTab_1nkth_1" };
...
var Counter = ({ count }) => /* @__PURE__ */ jsxs("span", { children: [
  "\u{1F6D2}",
  count
] });
var Header = ({ title, children, count = 0, className }) => {
  return /* @__PURE__ */ jsxs("div", { className: `${Header_module_css_default.headerTab} ${className}`, children: [
    /* @__PURE__ */ jsx2("h1", { children: title }),
    children,
    /* @__PURE__ */ jsx2("p", { children: output }),
    /* @__PURE__ */ jsx2(Counter, { count })
  ] });
};

// esbuild-css-modules-plugin-namespace:/var/folders/90/23sdvz916v38vly32_hh_f0r0000gn/T/tmp-67012-U5zQLx1ni0yM/ui/src/Footer/Footer.module.css.js
var digest3 = "b650cc12174cd2ecd409647a0a8c237e5706593c0b72e0dca0a3aad3e8294ce4";
var css3 = `._footer_rpcht_1{
...
var Footer_module_css_default = { "footer": "_footer_rpcht_1", "footerList": "_footerList_rpcht_7", "footerListItem": "_footerListItem_rpcht_11" };

// src/Footer/Footer.jsx
import { jsx as jsx3, jsxs as jsxs2 } from "react/jsx-runtime";
var Footer = ({ className }) => {
  return /* @__PURE__ */ jsxs2("div", { className: `${Footer_module_css_default.footer} ${className}`, children: [
    /* @__PURE__ */ jsxs2("div", { children: [
      "Copyright \xA9 2022",
      /* @__PURE__ */ jsx3("p", { children: "Disclaimer: This is a sample disclaimer for footer." })
    ] }),
    /* @__PURE__ */ jsxs2("div", { className: Footer_module_css_default.footerList, children: [
      /* @__PURE__ */ jsxs2("ul", { className: Footer_module_css_default.footerListItem, children: [
        /* @__PURE__ */ jsx3("li", { children: "About Us" }),
        /* @__PURE__ */ jsx3("li", { children: "Contact" })
      ] }),
      /* @__PURE__ */ jsxs2("ul", { className: Footer_module_css_default.footerListItem, children: [
        /* @__PURE__ */ jsx3("li", { children: "Follow Us" }),
        /* @__PURE__ */ jsx3("li", { children: "More Info" })
      ] })
    ] })
  ] });
};
